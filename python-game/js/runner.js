// Loads Pyodide, installs the bootstrap module, and runs student code.
...
const API_NAMES = [
  ...
  "turn", "move_forward",
  "open_chest", "pick_up_key", "go_to",
  "is_at_chest", "is_on_treasure",
  "is_wall_up", "is_wall_down", "is_wall_left", "is_wall_right",
  "is_key_up", "is_key_down", "is_key_left", "is_key_right",
  "has_key", "coins_collected",
...
export class Runner {
  ...
  async load() {
    ...
    this._loading = (async () => {
      ...
      // Tell Python which globals will be awaitable.
  ...
  async run(source) {
    ...
    // Bind API functions into Python's student namespace.
